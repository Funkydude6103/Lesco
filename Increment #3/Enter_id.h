...
namespace Project3 {
	...
	/// </summary>
	public ref class Enter_id : public System::Windows::Forms::Form
	{
	public:
		Enter_id(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Enter_id::typeid));
			...
			this->label1->Location = System::Drawing::Point(92, 60);
			...
			this->button1->Click += gcnew System::EventHandler(this, &Enter_id::button1_Click);
			// 
			// textBox1
			// 
			...
			this->panel1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->panel1->Location = System::Drawing::Point(13, 156);
			...
			this->Ok->Click += gcnew System::EventHandler(this, &Enter_id::Ok_Click);
			// 
			// button2
			// 
			this->button2->Location = System::Drawing::Point(585, 413);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(94, 63);
			this->button2->TabIndex = 5;
			this->button2->Text = L"Close";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &Enter_id::button2_Click);
			// 
			// Enter_id
			// 
			...
			this->ClientSize = System::Drawing::Size(690, 508);
			...
			this->Name = L"Enter_id";
			this->Text = L"Enter_id";
			this->Load += gcnew System::EventHandler(this, &Enter_id::Enter_id_Load_1);
...
#pragma warning(suppress : 4996)
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		std::string id = msclr::interop::marshal_as<std::string>(textBox1->Text);
		std::string temp;
